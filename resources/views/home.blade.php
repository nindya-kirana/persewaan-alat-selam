...
<body>
    <div class="hero-section">
        ...
        <div class="content">
            ...
            {{-- Letakkan tepat di bawah penutup .search-card --}}
            <div class="product-catalog" style="margin-top: 50px; width: 100%;">
                <h2 style="color: white; font-size: 32px; font-weight: 700; margin-bottom: 30px; text-align: left;">
                    Katalog Alat Tersedia
                </h2>

                {{-- Grid disesuaikan menjadi 4 kolom (1fr 1fr 1fr 1fr) --}}
                <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 20px;">
                    @forelse($products as $product)
                        <div style="background: white; border-radius: 15px; overflow: hidden; box-shadow: 0 8px 20px rgba(0,0,0,0.15); display: flex; flex-direction: column;">
                            
                            <div style="width: 100%; height: 180px; background: #f4f4f4; overflow: hidden;">
                                @php
                                    $path = $product->image;
                            ...
                            <div style="padding: 15px; flex-grow: 1; display: flex; flex-direction: column; justify-content: space-between;">
                                <div>
                                    <h3 style="color: #002d12; font-size: 16px; font-weight: 700; margin-bottom: 5px; line-height: 1.2;">
                                        {{ $product->nama_alat }}
                                    </h3>
                                </div>
                                ...
                                <div>
                                    <div style="margin-bottom: 10px;">
                                        <span style="display: block; font-size: 11px; color: #999;">Harga Sewa</span>
                                        <span style="font-size: 16px; font-weight: 700; color: #002d12;">
                                            Rp {{ number_format($product->variants->min('harga_per_hari'), 0, ',', '.') }} / hari
                                        </span>
                                    </div>
                                    <a href="#" style="display: block; text-align: center; background: #002d12; color: white; padding: 8px; border-radius: 8px; text-decoration: none; font-size: 13px; font-weight: 600; transition: 0.3s;">
                                        Detail
                                    </a>
                                </div>
                            </div>
                    ...
                    @empty
                        <div style="grid-column: 1 / -1; padding: 50px; text-align: center; color: white; border: 2px dashed rgba(255,255,255,0.3); border-radius: 20px;">
